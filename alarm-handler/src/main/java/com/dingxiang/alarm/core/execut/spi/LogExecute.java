package com.dingxiang.alarm.core.execut.spi;

import com.dingxiang.alarm.core.execut.api.IExecute;
import com.dingxiang.alarm.core.execut.gen.ExecuteNameGenerator;
...
public class LogExecute implements IExecute {
    ...
    public void sendMsg(List<String> users, String title, String msg) {
        logger.error("Do send msg by {} to user:{}, title: {}, msg: {}", getName(), users, title, msg);
    }
}
