package com.dingxiang.alarm.core.loader.helper;

import com.dingxiang.alarm.core.exceprion.RegisterInfoIllegalException;
import com.dingxiang.alarm.core.loader.entity.RegisterInfo;
import com.dingxiang.alarm.core.loader.util.PropertiesUtil;
            ...
            synchronized (RegisterInfoLoaderHelper.class) {
                if (instance == null) {
                    try {
                        ...
                        log.error("illegal register info: {}", ex.getMessage());
                        return null;
                    } catch (Exception e) {
                        log.error("load register info error: {}", e.getMessage());
                        return null;
                    }
                }
            }
